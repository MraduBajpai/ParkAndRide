...
-INSERT IGNORE INTO users (id, username, email, password, full_name, phone_number, role, enabled, account_non_expired, account_non_locked, credentials_non_expired, created_at, updated_at) VALUES
+-- Insert sample users (password is 'password' encoded with BCrypt)
...
-INSERT IGNORE INTO parking_lots (id, name, address, latitude, longitude, total_spots, available_spots, base_hourly_rate, metro_station_name, distance_from_metro, status, facilities, created_at, updated_at) VALUES
...
-INSERT IGNORE INTO parking_spots (id, spot_number, parking_lot_id, spot_type, status, floor, section, created_at, updated_at) VALUES
...
-INSERT IGNORE INTO parking_bookings (id, user_id, parking_lot_id, parking_spot_id, start_time, end_time, total_amount, status, booking_type, vehicle_number, access_pin, created_at, updated_at) VALUES
